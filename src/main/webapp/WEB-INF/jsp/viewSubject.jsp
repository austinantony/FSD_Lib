...
<div  class="container">
	<header class="row">
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-header">
				<h3 class="navbar-brand">Search a Subject</h3>
			</div>
	...
	<article class="content row">
		<form:form method="post" action="getSubject" class="form-horizontal">  
      	  
        <div class="form-group">
			<label class="control-label col-sm-2" for="subjectId">Subject Id</label>
			<div class="col-sm-4"> 
	...
	<c:if test="${showSub != null}">
	<div class="col-md-8 col-sm-9 col-xs-12">
		<table class="table table-striped">
			<tr><td><b>Subject Id</b></td><td>${showSub.subjectId}</td></tr>
			<tr><td><b>Subject Title</b></td><td>${showSub.subjectTitle}</td></tr>
			<tr><td><b>Duration</b></td><td>${showSub.duration}</td></tr>
		</table>	
	</div>
	</c:if>
	${message}
