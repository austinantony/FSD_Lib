...
<div  class="container">
	<header class="row">
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-header">
				<h3 class="navbar-brand">Search book by title</h3>
			</div>
	...
	<article class="content row">
		<form:form method="post" action="getBookByTitle" class="form-horizontal">  
	...
	<div class="col-md-8 col-sm-9 col-xs-12">
		...
		<thead class="thead-dark"><tr><th><b>Book Id</b></th><th><b>Title</b></th><th><b>Price</b></th><th><b>Volume</b></th><th><b>Purchase Date</b></th></tr></thead>
		<c:forEach items="${bookList}" var="showBook">
			<tr><td>${showBook.bookId}</td>
			<td>${showBook.title}</td>
			<td>${showBook.price}</td>
			<td>${showBook.volume}</td>
			<td>${showBook.publishedDate}</td></tr>
		</c:forEach>
		</table>	
	</div>
	${message}
