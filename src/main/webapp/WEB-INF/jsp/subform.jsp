...
<div  class="container">
	<header class="row">
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-header">
				<h3 class="navbar-brand">Add New Subject</h3>
			</div>
	...
	<div class="col-md-8 col-sm-9 col-xs-12">          
		<form:form method="post" action="addSubject" class="form-horizontal">  
        ...
        <div class="form-group">
			<label class="control-label col-sm-2" for="subjectTitle">Subject Title</label>
			<div class="col-sm-4">  
          	<form:input path="subjectTitle" class="form-control"/>
        </div></div> 
        <div class="form-group">
